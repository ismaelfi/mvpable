...
<div class="navbar max-w-7xl mx-auto px-4 bg-base-100">
    <div class="flex-1">
        <a href="{{ route('dashboard') }}" wire:navigate class="btn btn-ghost text-xl">MVPable</a>
    </div>
    <div class="flex-none">
        <label class="swap swap-rotate">
            <input type="checkbox" class="theme-controller hidden" id="theme-switcher" />
